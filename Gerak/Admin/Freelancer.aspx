<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Freelancer.aspx.vb" Inherits="Freelancer" %>
									...
									<table id="zero_config" class="table table-striped table-bordered">
										...
										<tbody>
											<tr>
												...
												<td>
													<button type="button" class="btn btn-primary btn-xs">Bekerja</button>
												</td>
												<td>
													<a href="EditFreelancer.aspx" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
											...
											<tr>
												...
												<td>
													<button type="button" class="btn btn-dark btn-xs">Tidak Bekerja</button>
												</td>
												<td>
													<a href="#" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
													<a href="#" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>

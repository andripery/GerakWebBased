<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Transaksi.aspx.vb" Inherits="Transaksi" %>
									...
									<table id="zero_config" class="table table-striped table-bordered">
										...
										<tbody>
											<tr>
												...
												<td>
													<button type="button" class="btn btn-primary btn-xs">Available</button>
												</td>
												<td>
													<a href="EditTransaksi.aspx" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
									...
									<table id="zero_config" class="table table-striped table-bordered">
										...
										<tbody>
											<tr>
												...
												<td>System Architect</td>
												<td>
													<button type="button" class="btn btn-dark btn-xs">Done</button>
												</td>
												<td>
													<a href="#" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
													<a href="#" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>

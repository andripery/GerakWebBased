<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EditFreelancer.aspx.vb" Inherits="EditFreelancer" %>
						...
						<div class="inbox-details-default">
							...
							<div class="inbox-details-body">
								...
								<form class="com-mail">
									...
									<input type="text"  value="Id Freelancer :" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Id Freelancer';}">
									<input type="text"  value="Nama :" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Nama';}">
									<input type="text"  value="Email :" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email';}">
									<input type="text"  value="Alamat :" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Alamat';}">
									<input type="text"  value="No HP :" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'No HP';}">
									<input type="text"  value="Kota :" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Kota';}">
									<input type="text"  value="Keahlian :" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Keahlian';}">
									<div class="form-group">
										<input type="image" src="#" alt="Submit">
										<br />
										<div class="btn btn-default btn-file">
											<i class="fa fa-paperclip"> </i> Foto KTP
											<input type="file" name="attachment">
										</div>
									</div>

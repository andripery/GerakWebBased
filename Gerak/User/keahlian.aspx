  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <h4><i class="fa fa-angle-right"></i> Ajukan Keahlianmu Sekarang!</h4>
            <div class="form-panel">
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="signupForm" method="get" action="">
                  ...
                  <div class="form-group ">
                    <label for="email" class="control-label col-lg-2">No Handphone</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="email" name="email" type="email" />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="email" class="control-label col-lg-2">Pilih Keahlian</label>
                    <div class="col-lg-10">
                  ...
                  <div class="form-group ">
                    <label for="email" class="control-label col-lg-2">Portofolio</label>
                    <div class="col-lg-10">
                      ...
                      <a href="advanced_form_components.aspx#" class="close fileupload-exists" data-dismiss="fileupload" style="float: none; margin-left:5px;"></a>
                    </div>
                    </div>
                  </div>
                  <div class="form-group ">
                  ...
                  <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                      <button class="btn btn-theme" type="submit">Ajukan</button>
    ...
    <footer class="site-footer">
      <div class="text-center">
        ...
        <a href="form_validation.aspx#" class="go-top">
